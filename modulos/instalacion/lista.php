                    ...
                    <?php else: ?>
                        <?php foreach ($instalaciones as $instalacion): ?>
                            <tr>
                                ...
                                <td><?= htmlspecialchars($instalacion['tecnico_responsable'] ?? 'Sin asignar') ?></td>
                                ...
                                <td>
                                    <div class="opciones-tabla-lista">
                                        ...
                                        <div class="iniciar"
                                            onclick="cambiarEstadoInstalacion(<?= $instalacion['id'] ?>, 'en_progreso')"
        ...
        <div class="modal-content-edicion">
            ...
            <form id="formEditarInstalacion">
                ...
                <div class="form-group">
                    <label for="edit_tecnico_responsable">Técnico Responsable:</label>
